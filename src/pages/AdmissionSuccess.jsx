...
export default function AdmissionSuccess() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#EEF9F7] pt-[90px] px-4 md:px-0 font-[Montserrat] text-[#2b2b2b] relative overflow-hidden">
        <Confetti numberOfPieces={100} recycle={false} />

        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-90px-200px)]">
          {/* Card */}
          <div className="bg-white shadow-[0_4px_16px_rgba(0,0,0,0.08)] rounded-2xl p-10 mb-10 text-center max-w-md w-full">
