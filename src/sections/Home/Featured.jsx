  ...
  return (
    <div className="h-auto pb-[105px] " id="featured">
      <div className="flex flex-col justify-center items-center mt-[70px] gap-[14px]">
        ...
        <p className="text-[14px] lg:text-[16px] px-[13px] text-[#5E6978] font-montserrat font-medium leading-[25.2px] tracking-[0.32px] text-center pb-[53px]">
          Elevate your learning experience with our diverse range <br /> of
      ...
      <div className="flex gap-[13px] justify-center items-center overflow-auto ">
        ...
        <Link to="/courses/Quran Recitation Course">
          <FeaturedCard
